(function () {
	...
	const syncDesktopBackground = () => {
		const route = frappe.get_route();
		const isDesktopHome = Array.isArray(route) && route[0] === "desktop";
		document.body.classList.toggle("lms-desktop-home", isDesktopHome);
	};
